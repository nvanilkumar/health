 ...
 * Logger::getInstance()->logInfo('Returned a million search results'); //Prints to the log file
 * Logger::getInstance()->logFatal('Oh dear.'); //Prints to the log file
 * Logger::getInstance()->logDebug('x = 5'); //Prints nothing due to current severity threshhold
 *
...
class KLogger
{
    ...
    private $_messages = array(
        //'writefail'   => 'The file exists, but could not be opened for
	// writing.
	// Check that appropriate permissions have been set.',
        'writefail'   => 'The file could not be written to. Check that appropriate
